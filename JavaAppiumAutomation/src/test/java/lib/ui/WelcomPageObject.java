...
public class WelcomPageObject extends MainPageObject
{
    private static final String
        ...
        STEP_NEW_WAYS_TO_EXPLORE_TEXT = "id:New ways to explorer",
    ...
    {
        this.waitForElementPresent(STEP_NEW_WAYS_TO_EXPLORE_TEXT, "Cannot find 'New ways to explorer' link", 10);
    }
    ...
    public void clickSkip() // клик по кнопке skip
    {
