...
public class AndroidSearchPageObject extends SearchPageObject
{
    static {
                ...
                SEARCH_RESULT_BY_SUBSTRING_TPL = "xpath://*[@resource-id='org.wikipedia:id/page_list_item_container']//*[contains(@text,'{SUBSTRING}')]";   //ожидает элемент по ресурс ид и тексту из /* TEMPLATES METHODS */
                ...
                SEARCH_BY_TITLE_AND_DESCRIPTION_TPL = "xpath://*[@text='{TITLE}']/following-sibling::*[contains(@text,'{SUBSTRING}')]"; //  TEMPLATES METHODS локатор тайтл + дескрипшен
    }
