...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String
            ...
            SEARCH_BY_TITLE_AND_DESCRIPTION_TPL = "//*[@text='{TITLE}']/following-sibling::*[@text='{DESCRIPTION}']"; //  TEMPLATES METHODS локатор тайтл + дескрипшен
    ...
    public void waitForElementByTitleAndDescription(String title, String description)   // проверяем наличие тайтла и дискрипшена
    {
        ...
        WebElement element = this.waitForElementPresent(By.xpath(search_result_xpath), "Cannot find search result with title" + title + " and " + description, 5);
    }
